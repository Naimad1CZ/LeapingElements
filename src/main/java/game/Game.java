...
public class Game extends Application {
    ...
    private List<MenuButton> initializeMainScene(Group mainSceneGroup) {
        ...
        // credits image and button handler
        initializeCredits(mainSceneGroup, creditsButton);
    ...
    private void initializeCredits(Group mainSceneGroup, MenuButton creditsButton) {
        // credits image
        ...
        creditsButton.setOnMouseReleased(event -> {
