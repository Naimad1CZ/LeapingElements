...
public class World extends AbstractWorld {
    ...
    /**
     * Updates and draws background, terrain, damian.myjavagame.game objects and HUD. Also calculates coordinates of the part of the map
     * that will be drawn.
    ...
    public void updateAndDraw(double delta) {
        try {
            ...
            int leftLabel = (int) (heroPosAvg.x - Constants.WIDTH / 2);
            int topLabel = (int) (heroPosAvg.y - Constants.HEIGHT / 2);

            if (leftLabel < 0) {
                leftLabel = 0;
            } else if (leftLabel + Constants.WIDTH > terrain.WIDTH) {
                leftLabel = terrain.WIDTH - Constants.WIDTH;
            }

            if (topLabel < 0) {
                topLabel = 0;
            } else if (topLabel + Constants.HEIGHT > terrain.HEIGHT) {
                topLabel = terrain.HEIGHT - Constants.HEIGHT;
            }
    ...
    /**
     * Add a GameOBject to the damian.myjavagame.game
    ...
    /**
     *
     * @return sum of the values of all stars in the damian.myjavagame.game
     */
